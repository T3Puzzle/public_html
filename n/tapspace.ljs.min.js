  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      t.exports = function t() {
        var e,
          ...
          p = !1;
        for (
          "boolean" == typeof c && ((p = c), (c = arguments[1] || {}), (f = 2)),
                ...
                c !== (i = l(e, n)) &&
                  (p && i && (u(i) || (o = a(i)))
                    ? (o
                        ? ((o = !1), (s = r && a(r) ? r : []))
                        : (s = r && u(r) ? r : {}),
                      h(c, { name: n, newValue: t(p, s, i) }))
                    : void 0 !== i && h(c, { name: n, newValue: i }));
        return c;
      };
    },
    function (t, e) {
      ...
      (r.almostEquals = r.almostEqual = function (t, e) {
        return (
          "number" != typeof e && (e = n.EPSILON),
          Math.abs(this.s - t.s) +
            Math.abs(this.r - t.r) +
            Math.abs(this.tx - t.tx) +
            Math.abs(this.ty - t.ty) <=
            e
        );
      }),
        ...
        (r.transform = function (t) {
          if ("number" == typeof t[0])
            return [
              this.s * t[0] - this.r * t[1] + this.tx,
              this.r * t[0] + this.s * t[1] + this.ty
            ];
          var e,
            n = [];
          for (e = 0; e < t.length; e += 1)
            n.push([
              this.s * t[e][0] - this.r * t[e][1] + this.tx,
              this.r * t[e][0] + this.s * t[e][1] + this.ty
            ]);
          return n;
        }),
        (r.inverse = function () {
          var t = this.s * this.s + this.r * this.r;
          if (Math.abs(t) < n.EPSILON)
    ...
    function (t, e, n) {
      ...
      (i.createFromPolar = function (t, e) {
        ...
        (i.mean = function (t) {
          var e,
            ...
            o = 0;
          if (n > 0) {
            for (e = 0; e < n; e += 1) (r += t[e].x), (o += t[e].y);
            return new i(r / n, o / n);
          }
      ...
      (o.add = function (t) {
        ...
        (o.changeBasis = function (t, e) {
          ...
          return new i(
            (this.y * e.x - this.x * e.y) / n,
            (this.x * t.y - this.y * t.x) / n
          );
        }),
        (o.changeFromBasis = function (t, e) {
          ...
          if (Math.abs(n) < r)
            throw new Error("Basis vectors must be linearly independent.");
          return new i(
            this.x * t.x + this.y * e.x,
            this.x * t.y + this.y * e.y
          );
        }),
        ...
        (o.rotate = function (t, e) {
          ...
          var n = this.x - e.x,
            r = this.y - e.y,
            o = n * Math.cos(t) - r * Math.sin(t),
            s = n * Math.sin(t) + r * Math.cos(t);
          return (n = o + e.x), (r = s + e.y), new i(n, r);
        }),
        (o.scale = function (t, e) {
          void 0 === e && (e = { x: 0, y: 0 });
          var n = this.x - e.x,
            r = this.y - e.y;
          return (n *= t), (r *= t), (n += e.x), (r += e.y), new i(n, r);
        }),
    ...
    function (t, e, n) {
      ...
      o.mean = function (t) {
        var e,
          ...
          s = 0;
        if (n > 0) {
          for (e = 0; e < n; e += 1) (i += t[e]._vec.x), (s += t[e]._vec.y);
          return new o(new r(i / n, s / n));
        }
      ...
      (s.add = function (t) {
        ...
        (s.offset = function (t, e, n) {
          ...
          return (
            (i = new r(t, e)),
            (s = n ? i.transform(n.getGlobalTransform()) : i),
            new o(this._vec.add(s))
          );
        }),
        (s.polarOffset = function (t, e, n) {
          var i, s, a, u;
          return (
            "number" != typeof t && (t = n ? t.to(n) : t.toSpace()),
            n &&
              ((t *= (u = n.getGlobalTransform()).getScale()),
              (e += u.getRotation())),
            (i = t * Math.cos(e)),
            (s = t * Math.sin(e)),
            (a = new r(i, s)),
            new o(this._vec.add(a))
          );
        }),
        (s.to = function (t) {
    ...
    function (t, e, n) {
      var r = n(2),
        ...
        a = s.prototype;
      (a.add = function (t) {
        if (Object.prototype.hasOwnProperty.call(t, "_seg"))
          return new s(this._seg.concat(t._seg));
        if (Object.prototype.hasOwnProperty.call(t, "x"))
          return new s(this._seg.concat([t]));
        throw new Error("Invalid Path or Vector");
      }),
        (a.almostEqual = function (t) {
          if (this._seg.length === t._seg.length) {
            for (var e = 0; e < this._seg.length; e += 1)
              if (!this._seg[e].almostEqual(t._seg[e])) return !1;
            return !0;
          }
          return !1;
        }),
        (a.atMid = function () {
          ...
          for (t = 0; t + 1 < n.length; t += 1)
            (e = n[t].x * n[t + 1].y - n[t + 1].x * n[t].y),
              (o += (n[t].x + n[t + 1].x) * e),
              (s += (n[t].y + n[t + 1].y) * e),
              (a += e);
          if (
            ((e = n[t].x * n[0].y - n[0].x * n[t].y),
            (o += (n[t].x + n[0].x) * e),
            (s += (n[t].y + n[0].y) * e),
            (a += e),
            Math.abs(a) < i)
          ) {
            for (o = 0, s = 0, t = 0; t < n.length; t += 1)
              (o += n[t].x), (s += n[t].y);
            return new r(o / n.length, s / n.length);
          }
          return new r((o *= 1 / (6 * (a *= 0.5))), (s *= 1 / (6 * a)));
        }),
        (a.bottom = function () {
          var t, e;
          if (0 === this._seg.length) return null;
          for (t = this._seg[0], e = 1; e < this._seg.length; e += 1)
            this._seg[e].y > t.y && (t = this._seg[e]);
          return t;
        }),
        (a.equal = a.equals = function (t) {
          if (this._seg.length === t._seg.length) {
            for (var e = 0; e < this._seg.length; e += 1)
              if (!this._seg[e].equals(t._seg[e])) return !1;
            return !0;
          }
          return !1;
        }),
        ...
        (a.getBounds = function () {
          ...
          if (0 === this._seg.length) return null;
          for (
            t = (a = this._seg[0]).x, e = a.y, n = a.x, i = a.y, o = 1;
            o < this._seg.length;
            o += 1
          )
            (a = this._seg[o]),
        ...
        (a.left = function () {
          ...
          if (0 === this._seg.length) return null;
          for (t = this._seg[0], e = 1; e < this._seg.length; e += 1)
            this._seg[e].x < t.x && (t = this._seg[e]);
          return t;
        }),
        (a.right = function () {
          var t, e;
    ...
    function (t, e, n) {
      var r = n(5),
        ...
        a = function (t, e) {
          ...
          if (t && !o(t, "tx")) throw new Error("invalid transform");
          void 0 === t && (t = r.IDENTITY),
            (this._tr = e ? s(t, e.getGlobalTransform()) : t);
        },
        u = a.prototype;
      (u.almostEqual = u.almostEquals = function (t) {
        return this._tr.almostEqual(t._tr);
      }),
        (u.equal = u.equals = function (t) {
          return this._tr.equals(t._tr);
        }),
        (u.inverse = function () {
          return new a(this._tr.inverse());
        }),
        (u.to = function (t) {
        ...
        (u.multiplyRight = u.multiplyBy = u.transformBy = function (t) {
          return new a(t._tr.multiplyBy(this._tr));
        }),
        (u.relativeTo = function (t) {
          return new a(this._tr.multiplyBy(t._tr.inverse()));
        }),
        (u.translate = function (t, e) {
          return a.estimate("T", t, e).multiplyRight(this);
        }),
        (u.scale = function (t, e, n) {
          ...
          return void 0 === n
            ? ((r = t.toSpace().toArray()),
              (i = e),
              (o = this._tr.scaleBy(i, r)),
              new a(o))
            : a.estimate("S", e, n, t).multiplyBy(this);
        }),
        (u.rotate = function (t, e, n) {
          var r, i, o;
          return void 0 === n
            ? ((r = t.toSpace().toArray()),
              (i = e),
              (o = this._tr.rotateBy(i, r)),
              new a(o))
            : a.estimate("R", e, n, t).multiplyBy(this);
        }),
        (u.translateScale = function (t, e) {
          return a.estimate("TS", t, e).multiplyBy(this);
        }),
        (u.translateRotate = function (t, e) {
          return a.estimate("TR", t, e).multiplyBy(this);
        }),
        (u.scaleRotate = function (t, e, n) {
          return a.estimate("SR", e, n, t).multiplyBy(this);
        }),
        (u.translateScaleRotate = function (t, e) {
          return a.estimate("TSR", t, e).multiplyBy(this);
        }),
        (a.IDENTITY = new a()),
        (a.estimate = function (t, e, n, r) {
          var s, u, h, l;
          void 0 !== r && (s = r.toSpace().toArray()),
            o(e, "_vec") ? (e = [e]) : o(e, "_p") && (e = e.toArray()),
            o(n, "_vec") ? (n = [n]) : o(n, "_p") && (n = n.toArray());
          var c = function (t) {
        ...
        o = function (t, e) {
          (this._p =
            void 0 === t
              ...
              : void 0 === e
              ? t
              : t.transform(e.getGlobalTransform())),
    ...
    function (t, e, n) {
      var r = n(3),
        ...
        h = n(14),
        l = function () {
          h.call(this), (this._size = new s(1, 1));
        },
        c = n(0)({}, h.prototype);
      (l.prototype = c),
        (c.atNorm = function (t, e) {
          if ("number" != typeof e)
            throw new Error(
              "Invalid (x, y) coordinates. Numbers are required."
            );
          return new r(
            new i(this._size.width * t, this._size.height * e),
            this
          );
        }),
        (c.atMid = function () {
        ...
        (c.fitScale = function (t) {
          var e,
            ...
            o,
            s,
            h = this.getHull().to(this).getBounds(),
            l = t.getHull().to(this).getBounds(),
            c = h.get(2).x - h.get(0).x,
            f = h.get(2).y - h.get(0).y,
            d = (l.get(2).x - l.get(0).x) / (l.get(2).y - l.get(0).y);
          return (
            d > c / f
              ? ((e = f / 2 - c / d / 2),
                (r = new u([
                  new i(h.get(0).x, h.get(0).y + e),
                  new i(h.get(1).x, h.get(1).y - e),
                  new i(h.get(2).x, h.get(2).y - e),
                  new i(h.get(3).x, h.get(3).y + e)
                ])))
              : ((n = c / 2 - (f * d) / 2),
                (r = new u([
                  new i(h.get(0).x + n, h.get(0).y),
                  new i(h.get(1).x + n, h.get(1).y),
                  new i(h.get(2).x - n, h.get(2).y),
                  new i(h.get(3).x - n, h.get(3).y)
                ]))),
            (o = new a(r, this)),
            (s = new a(l, this)),
            this.translateScale(o, s)
          );
        }),
        (c.fitSize = function (t) {
          var e = t.getHull().to(this).getBounds(),
            ...
            u = this._size;
          return (
            (this._size = new s(o, a)),
            this.translate(this.atNW(), new r(n, this)),
            this.emit("resized", {
              source: this,
              newSize: this._size,
              oldSize: u
        ...
        (c.getHull = function () {
          return new a(
            new u([
              new i(0, 0),
              new i(0, this._size.height),
              new i(this._size.width, this._size.height),
              new i(this._size.width, 0)
            ]),
            this
          );
        }),
    ...
    function (t, e) {
      ...
      (e.extend = function (t, e) {
        var r,
          i = {};
        for (r in t) n(t, r) && (i[r] = t[r]);
        for (r in e) n(e, r) && (i[r] = e[r]);
        return i;
      }),
        ...
        (e.clone = function (t) {
          var e,
            r = {};
          for (e in t) n(t, e) && (r[e] = t[e]);
          return r;
        }),
        (e.cardinality = function (t) {
          var e,
            r = 0;
          for (e in t) n(t, e) && (r += 1);
          return r;
        });
    },
    function (t, e, n) {
    ...
    function (t, e) {
      ...
      (r.add = function (t) {
        ...
        (r.multiply = function (t) {
          return new n(
            "number" == typeof t ? this._num * t : this._num * t._num
          );
        }),
    ...
    function (t, e, n) {
      ...
      (u.prototype = h),
        ...
        (h.getGlobalTransform = function () {
          var t, e;
          for (t = s.IDENTITY, e = this; null !== e._parent; )
            (t = e._T.multiplyRight(t)), (e = e._parent);
          return t;
        }),
        (h.getGlobalITransform = function () {
          var t, e;
          for (t = s.IDENTITY, e = this; null !== e._parent; )
            (t = e._T.multiplyRight(t)), (e = e._parent);
          return new r(t);
        }),
        (h.getLocalTransform = function () {
          return this._T;
        }),
        (h.getLocalITransform = function () {
          return null === this._parent
            ? r.IDENTITY
            : new r(this._T, this._parent);
        }),
        (h.resetTransform = function () {
          return this.setLocalTransform(s.IDENTITY);
        }),
        (h.setGlobalTransform = function (t) {
          var e;
          return (
            (e = (null === this._parent
              ? this._T
        ...
        (h.setGlobalITransform = function (t) {
        ...
        (h.setLocalITransform = function (t) {
        ...
        (h.transformBy = function (t, e) {
          return (
            void 0 === e && (e = this._parent),
            Object.prototype.hasOwnProperty.call(t, "_tr") && (t = t.to(e)),
            this.setLocalTransform(t.multiplyRight(this._T))
          );
        }),
        ...
        (h.translateScale = function (t, e) {
          var n = r.estimate("TS", t, e);
          return this.transformBy(n);
        }),
        (h.translateRotate = function (t, e) {
          var n = r.estimate("TR", t, e);
          return this.transformBy(n);
        }),
        (h.scaleRotate = function (t, e, n) {
          var i = r.estimate("SR", e, n, t);
          return this.transformBy(i);
        }),
        (h.translateScaleRotate = function (t, e) {
          var n = r.estimate("TSR", t, e);
          return this.transformBy(n);
        }),
        (h.setLocal3d = function (t, e) {
          var n = s.IDENTITY;
          n = n.translateBy(e.x, e.y);
          var r = 1 / Math.pow(2, e.z),
            i = t.to(this.getParent());
          (n = n.scaleBy(r, i.toArray())), this.setLocalTransform(n);
        }),
        (t.exports = u);
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      var r = n(4),
        ...
        l = function (t) {
          if (
            ((t = "object" != typeof t ? a : s({}, a, t)).xStep < r &&
              t.yStep > r) ||
            (t.xStep > r && t.yStep < r)
          )
            throw new Error(
              "Grid xStep and yStep must be either both zero or both greater than zero."
            );
          if (Math.abs(t.xRotation - t.yRotation) < r)
            throw new Error("Grid xRotation and yRotation cannot be the same.");
          this.mode = t;
        },
        c = l.prototype;
      (c.almostEqual = function (t) {
        var e,
          n = this.mode,
          i = t.mode;
        for (e in n)
        ...
        (c.getHullOf = function (t, e) {
          var n = this.mode,
            r = i.createFromPolar(n.xStep, n.xRotation),
            s = i.createFromPolar(n.yStep, n.yRotation),
            a = this.getOrigin(),
            u = a.add(r.multiply(t)).add(s.multiply(e)),
            h = a.add(r.multiply(t)).add(s.multiply(e + 1)),
            l = a.add(r.multiply(t + 1)).add(s.multiply(e + 1)),
            c = a.add(r.multiply(t + 1)).add(s.multiply(e));
          return new o([u, h, l, c]).getHull();
        }),
        ...
        (c.snap = function (t, e) {
          ...
          return (
            ...
            0 === g.xStep || 0 === g.yStep
              ? (f = l)
              : ((o = i.createFromPolar(g.xStep, g.xRotation)),
                (s = i.createFromPolar(g.yStep, g.yRotation)),
                (c = l.changeBasis(o, s)),
                (f = new i(
                  h(c.x, 1, g.xPhase / g.xStep),
                  h(c.y, 1, g.yPhase / g.yStep)
                ).changeFromBasis(o, s))),
            (n = f.x - l.x),
            (r = f.y - l.y),
            (d = (a = e.translateBy(n, r)).getScale()),
            (p = (0 === g.scaleStep ? d : h(d, g.scaleStep, g.scalePhase)) / d),
            (m = (u = a.scaleBy(p, f.toArray())).getRotation()),
            (v = 0 === g.rotateStep ? m : h(m, g.rotateStep, g.rotatePhase)),
            u.rotateBy(v - m, f.toArray())
          );
        }),
        (c.toArray = function () {
          return [this.mode];
        ...
        (c.transform = function (t) {
          var e = this.mode,
            ...
            o = t.getRotation();
          if (
            ((n.rotateStep = e.rotateStep),
            (n.rotatePhase = e.rotatePhase + o),
            (n.scaleStep = e.scaleStep * r),
            (n.scalePhase = e.scalePhase * r),
            0 === e.xStep || 0 === e.yStep)
          )
            (n.xStep = e.xStep),
              (n.yStep = e.yStep),
              (n.xRotation = e.xRotation),
              (n.yRotation = e.yRotation),
              (n.xPhase = e.xPhase),
              (n.yPhase = e.yPhase);
          else {
            var s = i.createFromPolar(e.xStep, e.xRotation),
              a = i.createFromPolar(e.yStep, e.yRotation),
              u = t.translateBy(-t.tx, -t.ty),
              h = s.transform(u),
              c = a.transform(u);
            (n.xStep = h.getMagnitude()),
              (n.yStep = c.getMagnitude()),
              (n.xRotation = h.getRotation()),
              (n.yRotation = c.getRotation());
            var f = e.xPhase / e.xStep,
              d = e.yPhase / e.yStep,
              p = new i(f, d)
                .changeFromBasis(s, a)
                .transform(t)
                .changeBasis(h, c),
              m = p.x * h.getMagnitude(),
              v = p.y * c.getMagnitude();
            (n.xPhase = m), (n.yPhase = v);
          }
          return new l(n);
        }),
        (t.exports = l);
    ...
    function (t, e, n) {
      ...
      (o.almostEqual = function (t) {
        return (
          Math.abs(this.width - t.width) + Math.abs(this.height - t.height) < r
        );
      }),
        (o.equal = function (t) {
      ...
      var r = n(10),
        ...
        o = function (t, e) {
          r.call(this),
            ...
            "object" == typeof e && this.setParent(e);
        },
        s = i({}, r.prototype);
      (o.prototype = s),
        (s.copy = function () {
        ...
        o = function (t, e) {
          ...
          r.call(this),
            t instanceof HTMLImageElement
              ? (this.image = t)
              : ((this.image = new Image(t.width, t.height)),
                (this.image.src = t.src)),
            this.setSize(t.width, t.height),
            "object" == typeof e && this.setParent(e);
        };
      ((o.prototype = i({}, r.prototype)).copy = function () {
    ...
    function (t, e, n) {
      var r = n(10),
        ...
        o = function (t, e) {
          r.call(this),
            (this.color = "string" == typeof t ? t : "#000000"),
            this.setSize(1, 1),
            "object" == typeof e && this.setParent(e);
        };
      ((o.prototype = i({}, r.prototype)).copy = function () {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        var n, i, o, s, a, u;
        if (((o = s = a = u = 0), (i = Math.min(t.length, e.length)) < 1))
          return r.IDENTITY;
        for (n = 0; n < i; n += 1)
          (o += t[n][0]), (s += t[n][1]), (a += e[n][0]), (u += e[n][1]);
        return new r(1, 0, (a - o) / i, (u - s) / i);
      };
    },
    function (t, e, n) {
      var r = n(1);
      t.exports = function (t, e, n) {
        var i, o, s, a, u, h, l, c, f, d, p, m;
        for (
          o = Math.min(t.length, e.length),
            c = f = d = p = 0,
            void 0 === n ? (a = u = 0) : ((a = n[0]), (u = n[1])),
            i = 0;
          i < o;
          i += 1
        )
        ...
        return 0 === (s = d + p)
          ? r.IDENTITY
          : ((m = Math.max(0, (c + f) / s)),
            new r(m, 0, (1 - m) * a, (1 - m) * u));
      };
    },
    function (t, e, n) {
      var r = n(1);
      t.exports = function (t, e, n) {
        var i, o, s, a, u, h, l, c, f, d, p, m, v, g, y, w, _;
        for (
          o = Math.min(t.length, e.length),
            d = p = m = v = 0,
            void 0 === n ? (a = u = 0) : ((a = n[0]), (u = n[1])),
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        for (u = h = l = c = f = d = p = m = 0, n = 0; n < y; n += 1)
          (u += i = v[n][0]),
            (h += o = v[n][1]),
            (l += s = g[n][0]),
            (c += a = g[n][1]),
        ...
        return S < 1e-8
          ? 0 === y
            ? new r(1, 0, 0, 0)
            : new r(1, 0, l / y - i, c / y - o)
          : new r(
              (w * E - y * (u * l + h * c)) / S,
              0,
              (-y * u * E + y * l * b - x * l + u * h * c) / S,
              (-y * h * E + y * c * b - _ * c + u * h * l) / S
            );
      };
    },
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        if (x < 1e-8)
          return 0 === y
            ? new r(1, 0, 0, 0)
            : new r(1, 0, (l - u) / y, (c - h) / y);
        var b = _ / x,
          E = w / x;
        return new r(b, E, (-u * b + h * E + l) / y, (-u * E - h * b + c) / y);
      };
    },
    function (t, e, n) {
      var r = n(1);
      t.exports = function (t, e, n) {
        ...
        var h,
          ...
          _ = n[0],
          x = n[1];
        for (p = m = 0, v = g = y = w = 0, h = 0; h < s; h += 1)
          (p += (l = i[h][0] - _) * l),
            (m += (c = i[h][1] - x) * c),
            (v += l * (f = o[h][0] - _)),
            (g += c * (d = o[h][1] - x)),
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        var n, i, o, s, a, u, h, l;
        if (((n = t), (i = e), 0 === (o = Math.min(n.length, i.length))))
          return new r(1, 0, 0, 0);
        var c = 0,
          f = 0,
          d = 0,
          p = 0,
        ...
        for (s = 0; s < o; s += 1)
          (c += a = n[s][0]),
            ...
            (w += a * h),
            (_ += u * l);
        var x = o * m + o * v - c * c - f * f;
        return -1e-8 < x && x < 1e-8
          ? new r(1, 0, d / o - a, p / o - u)
          : new r(
              (o * (w + _) - c * d - f * p) / x,
              (o * (g - y) + f * d - c * p) / x,
              (-c * (w + _) + f * (g - y) + m * d + v * d) / x,
              (-f * (w + _) - c * (g - y) + m * p + v * p) / x
            );
      };
    },
    function (t, e) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        var e = t.length;
        if (e < 3) {
          for (var n = new Array(e), i = 0; i < e; ++i) n[i] = i;
          return 2 === e && t[0][0] === t[1][0] && t[0][1] === t[1][1]
            ? [0]
            : n;
        }
        var o = new Array(e);
        ...
        for (i = 2; i < e; ++i) {
          for (
            var u = o[i], h = t[u], l = s.length;
            l > 1 && r(t[s[l - 2]], t[s[l - 1]], h) <= 0;

          )
            (l -= 1), s.pop();
          for (
            s.push(u), l = a.length;
            l > 1 && r(t[a[l - 2]], t[a[l - 1]], h) >= 0;
        ...
        for (var c = 0, f = ((i = 0), s.length); i < f; ++i) n[c++] = s[i];
        for (var d = a.length - 2; d > 0; --d) n[c++] = a[d];
        return n;
      };
      var r = n(36)[3];
    },
    function (t, e, n) {
      ...
      function l(t) {
        ...
        return new Function("sum", "prod", "scale", "sub", v)(i, r, o, s);
      }
      var c = l(3),
        f = l(4),
        d = [
          ...
          function (t, e, n, r) {
            var i = t[0] - r[0],
              ...
              x =
                ...
                ((Math.abs(p) + Math.abs(m)) * Math.abs(l) +
                  (Math.abs(v) + Math.abs(g)) * Math.abs(c) +
                  (Math.abs(y) + Math.abs(w)) * Math.abs(d));
            return _ > x || -_ > x ? _ : f(t, e, n, r);
          }
        ];
      function p(t) {
        var e = d[t.length];
      ...
      !(function () {
        for (; d.length <= 5; ) d.push(l(d.length));
        ...
        for (t.exports = o.apply(void 0, [p].concat(d)), r = 0; r <= 5; ++r)
          t.exports[r] = d[r];
      })();
    },
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        var i,
          ...
          p = l(d);
        f < p
          ? ((o = c), (u += 1) < n && ((c = t[u]), (f = l(c))))
          : ((o = d), (h += 1) < r && ((d = e[h]), (p = l(d))));
        (u < n && f < p) || h >= r
          ? ((i = c), (u += 1) < n && ((c = t[u]), (f = l(c))))
          : ((i = d), (h += 1) < r && ((d = e[h]), (p = l(d))));
        var m,
          v,
          g = i + o,
          y = g - i,
        ...
        for (; u < n && h < r; )
          f < p
            ? ((i = c), (u += 1) < n && ((c = t[u]), (f = l(c))))
            : ((i = d), (h += 1) < r && ((d = e[h]), (p = l(d)))),
            (w = (o = _) - (y = (g = i + o) - i)) && (s[a++] = w),
            (_ = x - ((m = x + g) - (v = m - x)) + (g - v)),
            (x = m);
        for (; u < n; )
          (w = (o = _) - (y = (g = (i = c) + o) - i)) && (s[a++] = w),
            (_ = x - ((m = x + g) - (v = m - x)) + (g - v)),
            (x = m),
            (u += 1) < n && (c = t[u]);
        for (; h < r; )
          (w = (o = _) - (y = (g = (i = d) + o) - i)) && (s[a++] = w),
            (_ = x - ((m = x + g) - (v = m - x)) + (g - v)),
            (x = m),
            (h += 1) < r && (d = e[h]);
        _ && (s[a++] = _);
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        var s = new Array(2 * n),
          ...
          u = [0.1, 0.1],
          h = 0;
        r(t[0], e, a), a[0] && (s[h++] = a[0]);
        for (var l = 1; l < n; ++l) {
          r(t[l], e, u);
          var c = a[1];
          i(c, u[0], a), a[0] && (s[h++] = a[0]);
          var f = u[1],
            d = a[1],
            p = f + d,
            m = d - (p - f);
        ...
        a = function (t, e) {
          void 0 === t
            ...
            : (Object.prototype.hasOwnProperty.call(t, "mode") ||
                (t = new s(t)),
              (this._grid =
                void 0 === e ? t : t.transform(e.getGlobalTransform())));
        },
        u = a.prototype;
      (u.almostEqual = function (t) {
      ...
      (s.prototype = a),
        ...
        (a.bringAbove = function (t) {
          ...
          var e = t._parent,
            ...
            r = this._parent;
          r === e && r._order.indexOf(this) <= n && (n -= 1),
            this.setParent(t._parent, n + 1);
        }),
        ...
        (a.getAncestors = function () {
          for (var t = this._parent, e = []; null !== t; )
            e.push(t), (t = t._parent);
          return e;
        }),
        ...
        (a.getDescendants = function () {
          var t, e, n, r;
          for (r = [], e = this.getChildren(), t = 0; t < e.length; t += 1)
            (n = e[t]), (r = r.concat(n, n.getDescendants()));
          return r;
        }),
        ...
        (a.setParent = function (t, e) {
          ...
          if (null === n)
            if (null === t);
              ...
              if (this === t || this.hasDescendant(t))
                throw new Error(
                  "Cyclic parent-child relationships are forbidden."
                );
              t._addChild(this, e),
                this.emit("added", {
                  source: this,
        ...
        (a._addChild = function (t, e) {
          ...
          (n._parent = this),
            r
              ? ((n._prevSibling = r), (r._nextSibling = n))
              : (n._prevSibling = null),
            i
              ? ((n._nextSibling = i), (i._prevSibling = n))
              : (n._nextSibling = null),
    ...
    function (t, e, n) {
      ...
      function r(t) {
        ...
        null == t && (t = (Math.random() - 0.5) * Math.pow(2, 32)),
          (this._id = 0 | t);
      }
      (t.exports = r),
    ...
    function (t, e, n) {
      var r = n(45),
        ...
        h = a({}, o.prototype);
      (u.prototype = h),
        (h.fitScale = function (t) {
          if (!this.isMounted())
            throw new Error(
              "View is not yet mounted and thus has no proper size for fitting. Call mount() before fitScale()."
            );
          return o.prototype.fitScale.call(this, t);
        }),
        (h.fitSize = function () {
          throw new Error(
            "Use refreshSize to resize the view and fitScale to fit."
          );
        }),
        (h.getElementBySpaceItem = function (t) {
        ...
        (h.getSpaceItemByElementId = function (t) {
          var e = document.getElementById(t);
          return e && Object.prototype.hasOwnProperty.call(e, "_tapspace_node")
            ? e._tapspace_node
            : null;
        }),
      ...
      var l = h.setParent;
      (h.setParent = function (t) {
        if (!(t instanceof s))
          throw new Error("A View can only be a child of a Space");
        this._parent !== t &&
          (null !== this._parent && this._removeElementOf(this._parent),
          l.call(this, t));
      }),
        (h.unmount = function () {
          this.isMounted() &&
            ...
            (this._viewHandlers = {}),
            this._parent && this._removeElementOf(this._parent),
            (this._el = null));
        }),
        (h.refreshSize = function () {
          if (!this.isMounted())
        ...
        (h._getViewSpecificId = function (t) {
          return this.id + "-" + t;
        }),
        (h._removeElementOf = function (t) {
          var e,
            n,
            r = this,
            i = t;
          ...
          i.getChildren().forEach(function (t) {
            ...
            i === this || i === this._parent
              ? i.off("childAdded", n.childAdded)
              : (i.off("childAdded", n.childAdded),
                i.off("removed", n.removed),
                i.off("resized", n.resized),
                i.off("transformed", n.transformed)),
            delete (e = this._elements[i.id])._tapspace_node,
            delete this._elements[i.id],
            delete this._handlers[i.id],
            e.parentElement.removeChild(e);
        }),
        (h._renderElementFor = function (t) {
          var e,
            n,
            s = this,
            a = t;
          ...
          if (Object.prototype.hasOwnProperty.call(this._elements, a.id))
            throw new Error(
              "An element should not be added twice to the same view."
            );
          ((e = r(a, u)).id = this._getViewSpecificId(a.id)),
            (e._tapspace_node = a),
            (this._elements[a.id] = e),
            a === this._parent
              ? (this._el.appendChild(e),
                (n = {
                  childAdded: function (t) {
                    t.newChild !== s &&
                      (t.oldParent === t.source
                        ? s._reorderElementOf(t.newChild)
                        : s._renderElementFor(t.newChild));
                  }
                }),
                a.on("childAdded", n.childAdded))
              : (this._elements[a.getParent().id].appendChild(e),
                a === this
                  ? ((n = {
                      childAdded: function (t) {
                        t.oldParent === t.source
                  ...
                  : ((n = {
                      ...
                      removed: function (t) {
                        t.oldParent === t.newParent || s._removeElementOf(a);
                      },
                      resized: function () {
                        s._resizeElementOf(a);
                      },
                      transformed: function () {
                        i(s._elements[a.id], a._T);
                      }
                    }),
                    a.on("childAdded", n.childAdded),
                    a.on("removed", n.removed),
                    a.on("resized", n.resized),
                    a.on("transformed", n.transformed),
                    a instanceof o && n.resized(),
                    n.transformed())),
            (this._handlers[a.id] = n),
            a.getChildren().forEach(function (t) {
              s._renderElementFor(t);
            });
        }),
        (h._reorderElementOf = function (t) {
          var e, n, r, i;
          (e = this._elements[t.id]),
            (n = this._elements[t._parent.id]),
            (r = t.getNextSibling())
              ? ((i = this._elements[r.id]), n.insertBefore(e, i))
              : n.appendChild(e);
        }),
        (h._resizeElementOf = function (t) {
          var e, n;
          (n = t.getSize()),
            ((e = this._elements[t.id]).style.width = n.width + "px"),
            (e.style.height = n.height + "px");
        }),
        (h._setSize = o.prototype.setSize),
        (t.exports = u);
    },
    function (t, e, n) {
      var r = n(9),
      ...
      t.exports = function (t, e) {
        var n,
          ...
          h = t;
        if (h instanceof s)
          (n = h.image.cloneNode()).className = "tapspace-image";
        else if (h instanceof o)
          ((n = document.createElement("div")).innerHTML = h.html),
            (n.className = "tapspace-html");
        else {
          if (!(h instanceof a)) {
            if (h instanceof e)
              return (
          ...
          ((n = document.createElement("div")).className = "tapspace-pixel"),
            (n.style.backgroundColor = h.color);
        }
        return (
          (u = h.getSize()),
          (n.style.width = u.width + "px"),
          (n.style.height = u.height + "px"),
          (n.style.display = "inline-block"),
          (n.style.position = "absolute"),
          (n.style.transformOrigin = "0 0"),
          n
    ...
    function (t, e, n) {
      var r = n(15),
        ...
        a = new o(),
        u = function (t, e, n) {
          if ((r(this), null === t.getContainer()))
            throw new Error("Touchable requires a mounted view.");
          if (
            ((this.view = t),
            (this.item = e),
            (this.targetItem = void 0 === n ? e : n),
            this.view === this.item)
          )
            ...
            throw new Error(
              "No HTMLElement found. Ensure the item is in the same space with the view."
            );
          (this.mode = u.DEFAULT_MODE), (this._rec = null);
        };
      (u.DEFAULT_MODE = {
        rotate: !1,
        scale: !1,
        ...
        (u.prototype.start = function (t) {
          a.start(this.view),
            (this.mode = s.extend(u.DEFAULT_MODE, t)),
            null === this._rec
              ? (this._rec = new i(this))
              : this._rec.update(this.mode);
        }),
        (u.prototype.restart = function (t) {
          return this.start(t);
        }),
        ...
        (u.prototype.stop = function () {
          null !== this._rec &&
            (this._rec.destroy(), (this._rec = null), a.stop(this.view));
        }),
        (t.exports = u);
    },
    function (t, e, n) {
      var r = n(49),
        ...
        l = function (t, e, n) {
          ...
          var r,
            ...
            s = n.getGlobalTransform().inverse().multiplyRight(o);
          for (r in t) h(t, r) && (i[r] = s.transform(t[r]));
          return i;
        },
        c = function (t) {
          var e,
            n = [];
          for (e in t) h(t, e) && n.push(new s(new a(t[e][0], t[e][1])));
          return n;
        },
        f = function (t) {
          var e = this;
              ...
              start: function (t) {
                ...
                (n = Date.now()),
                  ...
                  (f = (function (t, e) {
                    var n,
                      r = {},
                      i = e.getGlobalTransform();
                    for (n in t) h(t, n) && (r[n] = i.transform(t[n]));
                    return r;
                  })(t, i)),
                  e.man.emit("gesturestart", {
                    distance: 0,
                    duration: 0,
                    element: o,
                    item: e.man.targetItem
                  });
              },
              move: function (t, r) {
                var c,
                  ...
                  S = e.man.mode,
                  T = l(r, x, b);
                for (c in a) h(a, c) && h(T, c) && (y.push(a[c]), w.push(T[c]));
                var P = x.getGlobalTransform();
                for (c in T) h(T, c) && !h(f, c) && (f[c] = P.transform(T[c]));
                for (c in ((d = y.length), t))
                  h(t, c) &&
                    h(r, c) &&
                    ((s += Math.abs(t[c][0] - r[c][0]) / d),
                    (s += Math.abs(t[c][1] - r[c][1]) / d));
                (p = (function (t, e) {
                  return t.pivot
                    ? t.pivot.to(e).toArray()
                    : !1 === t.translate
                    ? e.atMid().to(e).toArray()
                    : void 0;
                })(S, b)),
                  (m = i.convertToTransformationType(S)),
                  (v = u.estimate(m, y, w, p)),
                  (g = new o(v, b)),
                  "function" == typeof E
                    ? ((a = T), E(g))
                    : x === E
                    ? ((a = T), x.transformBy(g.inverse()))
                    : ((a = (function (t, e) {
                        var n,
                          r = {};
                        for (n in t) h(t, n) && (r[n] = e.transform(t[n]));
                        return r;
                      })(T, v.inverse())),
                      E.transformBy(g)),
                  e.man.emit("gesturemove", {
                    distance: s,
                    duration: Date.now() - n,
                    element: _,
                    item: E
        ...
        var i = {},
          ...
          c = function (t) {
            ...
            if (!t.defaultPrevented) {
              for (
                ...
                i[e[n].identifier] = [e[n].pageX, e[n].pageY];
              u || ((u = !0), s.start(i)), (l = i);
            }
          },
          f = function (t) {
          ...
          d = function (t) {
            ...
            if (!t.defaultPrevented) {
              for (
                ...
                delete i[e[n].identifier];
              r.cardinality(i) < 1 && ((u = !1), s.end(l)), (l = i);
            }
          },
          p = function (t) {
            var e;
            t.defaultPrevented ||
              ...
              h ||
                ((h = !0),
                ((e = r.clone(l)).mouse = [t.pageX, t.pageY]),
                u || ((u = !0), s.start(e)),
                (l = e)));
          },
          m = function (t) {
          ...
          v = function (t) {
            ...
            h &&
              ...
              ((h = !1),
              o && t.preventDefault(),
              delete (e = r.clone(l)).mouse,
              r.cardinality(e) < 1 && ((u = !1), s.end(l)),
              (l = e));
          };
        a.addEventListener("touchstart", c, { passive: !1 }),
    ...
    function (t, e) {
      ...
      (n.prototype.start = function (t) {
        var e, n, r, i, o, s, a;
        Object.prototype.hasOwnProperty.call(this.numRunning, t.id)
          ? (this.numRunning[t.id] += 1)
          : ((this.numRunning[t.id] = 1),
            (this.handlers[t.id] =
              ((e = t.getContainer()),
              (n = !1),
              ...
              (i = function (t) {
                if (!n && !t.defaultPrevented) {
                  ...
                  e.initEvent("ratstart", !0, !0),
                    (r),
                    (e.pageX = t.pageX),
                    (e.pageY = t.pageY),
                    !r.dispatchEvent(e) && t.preventDefault();
              ...
              e.addEventListener("ratstart", a),
              e.addEventListener("ratmove", a),
              e.addEventListener("ratend", a),
              {
                container: e,
                mousedown: i,
                mousemove: o,
        ...
        (n.prototype.stop = function (t) {
          if (!Object.prototype.hasOwnProperty.call(this.numRunning, t.id))
            throw new Error("Stop called before start.");
          var e, n, r;
          (this.numRunning[t.id] -= 1),
            this.numRunning[t.id] < 1 &&
              ((e = this.handlers[t.id]),
              (r = (n = e).container).removeEventListener(
                "mousedown",
                n.mousedown
              ),
              r.removeEventListener("mousemove", n.mousemove),
              r.removeEventListener("mouseup", n.mouseup),
              r.removeEventListener("mouseleave", n.mouseleave),
              r.removeEventListener("ratstart", n.ratstart),
              r.removeEventListener("ratmove", n.ratmove),
              r.removeEventListener("ratend", n.ratend),
    ...
    function (t, e, n) {
      ...
      (s.DEFAULT_MODE = {
        ...
        (s.prototype.start = function (t) {
          var e, n, r;
          (this.mode = o.extend(s.DEFAULT_MODE, t)),
            null === this._rec
              ? ((e = this.element),
                (n = this.targetItem),
                (r = this.view),
                (this._rec = new i(e, n, r, this, this.mode)))
              : this._rec.update(this.mode);
        }),
        ...
        a = function (t, e, n, a, u) {
          ...
          var l = function (t) {
            ...
            t.preventDefault(),
              ...
              h.mode.translate
                ? h.mode.scale
                  ? ((a = new s(new o(l, c), h.view)),
                    (n = n
                      .scale(a, 1 + d / 1e3)
                      .translate(h.view.at(0, 0), h.view.at(f, 0))))
                  : ((e = new r(1, 0, f, d)), (n = new i(e, h.view)))
                : h.mode.scale &&
                  ((a = new s(new o(l, c), h.view)),
                  (n = n.scale(a, 1 + d / 1e3))),
              h.mode.rotate &&
                ((a = new s(new o(l, c), h.view)), (n = n.rotate(a, p / 1e3))),
              h.view === h.target
                ? h.view.transformBy(n)
                : "function" == typeof h.target
                ? h.target(n.inverse())
                : h.target.transformBy(n.inverse()),
              (m = { element: h.element, item: h.target, originalEvent: t }),
              h.started || h.emitter.emit("gesturestart", m),
              h.emitter.emit("gesturemove", m),
              h.emitter.emit("wheel", m),
              clearTimeout(h.lastWheelTimeout),
              (h.lastWheelTimeout = setTimeout(function () {
                (h.started = !1),
                  (h.lastWheelTimeout = null),
                  h.emitter.emit("gestureend", m);
              }, u.endInterval));
          };
          this.element.addEventListener("wheel", l, { passive: !1 }),
            (this.listener = l);
        };
    ...
    function (t, e) {
      t.exports = function (t, e) {
        ...
        if ("function" != typeof e)
          throw new Error("callback should be a function: " + e);
        for (
          "string" == typeof t
            ? ((n = 1), (r = !0), (t = [t]))
            : ((n = t.length), (r = !1)),
...
let t = ()=>tapspace;
//export { t as tapspace };
return _export ({tapspace: t});
