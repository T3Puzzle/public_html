(()=>{
let url='https://script.google.com/a/tessellation.jp/macros/s/AKfycby6dVAXJv9HB0Ke7zgXg3rpymLlSDXRmhjxGQmt2Mr2gZiYIPqn/exec';
let upload=null;
let filename=null;
...
<a class="${name}" style="text-decoration:none;vertical-align:0.2em;font-size:300%;margin-right:0.2em;">⬇</a>
`);
...
`);
  ...
  uploads = output.querySelectorAll(`a.${name}`);
  for (let ui=0;ui<uploads.length;ui++) {
    let upload = uploads[ui];
    upload.href = '#';
