...
(()=>{
  let url = 'https://script.google.com/a/tessellation.jp/macros/s/AKfycbztbT-dUSUeonX-F_q4mEDeVQUqTpX-_ZmrqYAhDNsEx84nuTwkjjOj5bjy1r5s_69D/exec';
  let emailreq = '';
...
<dt>くふうしたこと</dt>
<dd><textarea placeholder="くふうしたこと　&#010;作品および記入内容は公開させていただくことがあります(メールアドレスを除く)" style="font-size:90%;" cols="33" rows="3" name="text" required></textarea></dd>
  `;
...
<img style="width:600px;" src="./hachikosteamcontestlogo.png"><br/>
作品の画像ファイルを選択の上、<br/>
必須事項を記入して下さい。<br/>
